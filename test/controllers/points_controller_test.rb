...
class PointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create point" do
    assert_difference("Point.count") do
      post points_url, params: { point: { customer_id: @point.customer_id, point: @point.point } }
    end
  ...
  test "should update point" do
    patch point_url(@point), params: { point: { customer_id: @point.customer_id, point: @point.point } }
